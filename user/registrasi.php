<?php
    ...
    if ( isset($_POST["register"]) ) {
        ...
        if ( registrasi($_POST) > 0 ) {
            echo "<script>
                    alert('user baru berhasil ditambahkan');window.location='index.php';
                  </script>";
...
<!------ Include the above in your HEAD tag ---------->
  ...
  <div class="wrapper fadeInDown">
    <div id="formContent">
      ...
      <div id="formFooter2">
        <p> Buat akun sebagai user </p>
      </div>


      <!-- Login Form -->
      <form action="" method="POST">
        <input type="text" id="login" class="fadeIn second" name="username" placeholder="buat username" autocomplete="off" required oninvalid="this.setCustomValidity('masukan username Anda')" oninput="setCustomValidity('')">
