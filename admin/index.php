  ...
  <div class="wrapper fadeInDown">
    <div id="formContent">
      ...
      <form action="" method="POST">
        <input type="text" id="login" class="fadeIn second" name="username" placeholder="username" required oninvalid="this.setCustomValidity('masukan username Anda')" oninput="setCustomValidity('')" />
