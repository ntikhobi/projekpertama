...
<?php
  ...
  require '../fungsi_Asn.php';

  if ( isset ($_POST["tambahdata"]) ) {
    
    if ( tambah_Asn ($_POST) > 0 ) {
      ...
      echo "
            <script>
              alert('Data Gagal Disimpan');window.location='formAsn.php';
            </script>
      ";
      ...
      <div class="page-content d-flex align-items-stretch"> 
        ...
        <div class="content-inner">
          ...
          <header class="page-header">
            <div class="container-fluid">
              <h2 class="no-margin-bottom"> Data Pegawai ASN SAMSAT Subang </h2>
            </div>          
          </header>
        ...
        <div class="table-responsive-md">
          ...
          <a href="formAsn.php" class="btn btn-primary" style="margin:30px;"> Tambah data</a>
                      ...
                      $data =  mysqli_query($conn,"SELECT * FROM pegawai ");
                        ...
                        ?>
                          ...
                          <td>
                            ...
                            <a href="detailAsn.php?id=<?php echo $d['id']; ?>"><button class="btn btn-info btn-xs">lihat detail</button></a>
                            <a href="editdataAsn.php?id=<?php echo $d['id']; ?>"><button class="btn btn-secondary"> edit data </button></a>
                            <a href="hapusdataAsn.php?id=<?php echo $d['id']; ?>" onclick="return confirm('Yakin Anda ingin menghapus <?php echo $d['nama_pegawai']; ?>');"><button class="btn btn-danger btn-xs">
                              hapus data
                            </button></a>
                            <a href="cetak.php?id=<?php echo $d['id']; ?>"><button class="btn btn-secondary"> edit data </button></a>
                          </td>
