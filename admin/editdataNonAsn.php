<?php
  ...
  $query = "SELECT * FROM nonasn WHERE id=" . $id;
...
<?php
  ...
  // $sql = query("SELECT * FROM nonasn WHERE id=$id"); 

  // if ( isset ($_POST["tambahdata"]) ) {
    
  //   if ( !ubah_nonAsn ($_POST) > 0 ) {
  ...
  //     echo "
  //           <script>
  //             alert('Data Gagal ditambahkan');window.location='home.php';
  //           </script>
  //     ";
  //   }
  // }
...
<html>
  <head>
    ...
    <title> Edit Data Pegawai Samsat Subang </title>
      ...
      <div class="page-content d-flex align-items-stretch"> 
        ...
        <div class="content-inner">
          ...
          <header class="page-header">
            <div class="container-fluid">
              <h2 class="no-margin-bottom">Edit Data Pegawai </h2>
            </div>
          </header>

          <!-- Form Data -->
          <div class="modal-body">
            <form  action="proseseditdataNonAsn.php" method="post">
              ...
              <button type="submit" class="btn btn-primary" name="tambahdata"> Ubah </button>
