...
<?php
  ...
  if ( isset ($_POST["tambahdata"]) ) {
    ...
    if ( tambah_nonAsn ($_POST) > 0 ) {
      ...
      echo "
            <script>
              alert('Data Gagal Disimpan');window.location='home.php';
            </script>
      ";
      ...
      <div class="page-content d-flex align-items-stretch"> 
        ...
        <div class="content-inner">
          ...
          <header class="page-header">
            <div class="container-fluid">
              <h2 class="no-margin-bottom"> Data Pegawai Non ASN SAMSAT Subang </h2>
            </div>          
          </header>

          <div class="container-table">
            <div class="table-responsive-md">
              <a href="formNonAsn.php" class="btn btn-primary" style="margin:30px;"> Tambah data</a>
              <center>
                <table class="table">    
                  <thead>
                      <tr>
                      ...
                      $data =  mysqli_query($conn,"SELECT * FROM nonasn");
                        ...
                        ?>
                          ...
                          <td>                     
                            ...
                            <a href="cetak_NonAsn.php?id=<?php echo $d['id']; ?>"><button class="btn btn-secondary"> cetak data </button></a>
                          </td>                
                        <?php
                      }
                    ?>
